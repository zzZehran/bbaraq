    ...
    <>
      ...
      <ShadowBox>
        <p className="px-5 pt-5 px-md-5 px-lg-5">
          ...
          functionality. From kitchen remodels to full-scale renovations, our
          team delivers tailored solutions that exceed expectations. Trust Lorem
          Homes Inc. to elevate your property to new heights of elegance and
          comfort through our comprehensive renovation services.
        </p>
        <Services />
        <ScheduleVisit />
      </ShadowBox>
